...
// router.get("/setPwd", function (req, res, next) {
//   var pathName = path.join(rootPath, "index.html");
//   Application.render(res, pathName);
// }); 

// router.get("/salaryList", function (req, res, next) {
//   var pathName = path.join(rootPath, "index.html");
//   Application.render(res, pathName);
// }); 

// router.get("/salaryDetail", function (req, res, next) {
//   var pathName = path.join(rootPath, "index.html");
//   Application.render(res, pathName);
// }); 

// router.get('/*', (req, res, next) => {
//   res.send('{"result":true,"error":{"code":0,"msg":"OK"}}');
// });
...
router.all(/\//, function (req, res, next) {
  if (req.method.toLowerCase() === "options") {
    ...
    res.set("Access-Control-Allow-Headers","X-Requested-With, Origin, token, userid, orgid, appkey, authInfo, Authorization, cookie, sid ,Content-Type");
...
var Application = {
    render: function (response, pathname) {
            ...
            if(pathname.indexOf("/nodejs/")!=-1){
              console.log("exists",fs.existsSync(pathname))
...
var ServiceProxy = {
    ...
    get: function () {
      ...
      request(context.url, function (error, response, body) {
